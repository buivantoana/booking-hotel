      ...
      <Container maxWidth='lg' sx={{ py: { xs: 6, md: 15 } }}>
        ...
        <Box
          ...
          <img
            ...
            alt=''
          />
          <Box display={"flex"} sx={{position:"absolute",top:0,left:0,width:"100%",height:"100%"}}>
            <Box flex={1} onClick={()=>{
              navigate(`/rooms?location=${address?.id||"hanoi"}&type=hourly`)
            }}>
        ...
        <FirstTimeExplore setAddress={setAddress} address={address} location={location}  />
        <ListRoom
          loading={loading}
          data={featured}
        ...
        />
        <ListRoom loading={loading} data={recommend} location={address?.id||"hanoi"} category={"recommend"} title={"Gợi ý cho bạn"} />
        <ListRoom
          loading={loading}
          data={toprated}
          category={"toprated"} 
