    ...
    return (
      <Stack spacing={3}>
        ...
        <Stack direction="row" alignItems="center" spacing={1}>
          <IconButton
            size="small"
            onClick={() => (isMobile ? setDrawerOpen(true) : setDetailBooking(false))}
          >
            {isMobile ? <MenuIcon sx={{ fontSize: 22 }} /> : <ArrowBackIcon sx={{ fontSize: 20 }} />}
          </IconButton>
        ...
        {detailBooking.status === "confirmed" && detailBooking?.payments?.[0]?.status =="paid"&&
        <Paper elevation={0} sx={{ borderRadius: "16px", bgcolor: "white", p: 2.5 }}>
          <Stack direction="row" justifyContent="space-between" alignItems="center">
            <Stack direction="row" spacing={2} alignItems="center">
        ...
        {detailBooking.status === "pending" && (detailBooking?.payments?.[0]?.status =="failed"||detailBooking?.payments?.[0]?.status =="pending")&&
        <Paper elevation={0} sx={{ borderRadius: "16px", bgcolor: "white", p: 2.5 }}>
          <Stack direction="row" justifyContent="space-between" alignItems="center">
            <Stack direction="row" spacing={2} alignItems="center">
          ...
          <Stack direction="row" spacing={2} alignItems="flex-start">
            ...
            >
              ...
              <Grid container spacing={0.5} mt={1} fontSize="0.7rem">
                <Grid item xs={4}>
                  <Typography color="#888" fontSize="0.75rem">Nhận phòng</Typography>
                  <Typography fontWeight={600} color="#333" fontSize="0.8rem">
                    {checkInTime}
                  </Typography>
                </Grid>
                <Grid item xs={4} sx={{ borderLeft: "1px solid #ddd", textAlign: "center" }}>
                  <Typography color="#888" fontSize="0.75rem">Trả phòng</Typography>
                  <Typography fontWeight={600} color="#333" fontSize="0.8rem">
                    {checkOutTime}
                  </Typography>
                </Grid>
        ...
        <Paper elevation={0} sx={{ borderRadius: "16px", bgcolor: "white", p: 2.5 }}>
          ...
          <Stack spacing={2}>
            <Stack direction="row" justifyContent="space-between">
              <Typography fontSize="0.9rem" color="#666">Trạng thái</Typography>
              <Typography fontWeight={600} color={payment?.status === "success" ? "#98b720" : "#ff4444"} fontSize="0.95rem">
                {paymentStatus}
              </Typography>
            </Stack>
            <Stack direction="row" justifyContent="space-between">
